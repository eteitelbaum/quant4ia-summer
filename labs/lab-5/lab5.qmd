...
Fill in each `???` with the correct code. You are encouraged to have Modules 5.1 and 5.2 open while completing this lab.
...
You will work with cross-national data from the V-Dem project. Parts 1 and 2 use data from **2019** and focus on a simple research question: **Are more democratic countries less corrupt?** Parts 3 and 4 use data from **2006** to match the lecture slides.
...
Fill in the `???` to filter V-Dem to the year 2006 and select the relevant variables.
...
Parts 1 & 2: `filter(year == 2019)`

Parts 3 & 4: `filter(year == 2006)`
