...
- Predicted probabilities below 0 or above 1 are meaningless
- The relationship between a predictor and a probability is rarely linear across the full range
- We need a model that constrains predictions to [0, 1]
:::
