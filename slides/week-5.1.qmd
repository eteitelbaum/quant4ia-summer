...
cor(modelData$log_wealth, modelData$lib_dem)
```
...
An R² of ≈ 0.28 means log GDP per capita explains **28%** of the variation in democracy scores. The remaining 72% is explained by other factors.
